...
/// Gemini OAuth Client credentials (public values from Gemini CLI open source)
const GEMINI_OAUTH_CLIENT_ID: &str = "YOUR_GEMINI_CLIENT_ID";
const GEMINI_OAUTH_CLIENT_SECRET: &str = "YOUR_GEMINI_CLIENT_SECRET";
